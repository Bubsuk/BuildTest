...
namespace Container.Build
{
    ...
    {
        /* App Info */
        private const string APP_NAME = "TEST"; //APK 명칭
        protected const string KEYSTORE_PASSWORD = "********"; // 안쓰는걸 추천
        ...
        // 젠킨스 테스트 성공하면 수정하기
        public static void GenericBuild(BuildPlayerOptions options)
        {
            EditorUserBuildSettings.SwitchActiveBuildTargetAsync(options.targetGroup, options.target); // Async를 떼야 할 수도 있음
